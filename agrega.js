...
document.querySelector("#apalabra").addEventListener("click", () => {
    nueva = document.querySelector("#paAgre").value;
    nuevamayus = nueva.toUpperCase();
    palabras.push(nuevamayus);
    console.log(palabras);
});

document.querySelector("#jugar").addEventListener("click", () => {
    document.querySelector("#nuevaspalabras").style.display = "none";
    document.querySelector("#vamosajugar").style.display = "flex";
